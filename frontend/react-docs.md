...
- Example with setting element to variable 
...
- Example using inline conditions with embedded expressions 
...
- To prevent component from rendering, return `null`
  - otherwise if your conditional results in false, then you will return `<div>0</div>`
